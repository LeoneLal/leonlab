    ...
    <div class="formulaire">
        ...
        <form method="POST" action="{{ route('comments.update', $comment->id) }}">
            ...
            <div class="form-group">
                ...
                <input type="number" min="0" max="5" id="note" name="note" class="form-control"  value="{{$comment->note}}">
            </div>

            <div class="form-group">
                <label for="avis">Avis</label>
                <input type="text" class="form-control" name="avis" id="avis" value="{{$comment->avis}}">
            </div>
